#!/usr/bin/env python
#-*- coding:utf-8 -*-
# @Time    : 2019-10-22 15:25
# @Author  : liyang109
from __future__ import print_function
"""日志分析简单版"""
# keyword = "Epoch"
# record = []
# with open('resnet','r') as f:
#     lines = f.readlines()
#     for line in lines:
...
#         sum_record += eval(record[i])
#
#     print sum_record
#
#     avg_count = sum_record / count
#     print avg_count
...
def parse_args():
    ...
    parser.add_argument(
        '--model_name', type=str, default='resnet', help='training model_name, transformer_base')
    parser.add_argument(
...
class TimeAnalyzer(object):
    ...
    def _distil(self):
        ...
        with open(self.filename, "r") as f_object:
            ...
            # sum_of_record = sum(records_list[:])
            # print(sum_of_record)
...
if __name__ == '__main__':
    ...
    analyzer = TimeAnalyzer('resnet','Epoch'," ",11,"3")
    analyzer.analysis(32,1,2,3)

    print("{}".format(json.dumps(run_info)))#这个主要是为了写入数据库方便
